...
template <typename t_stream, typename t_key_type, typename t_eq, typename t_hash>
t_stream &operator<<(t_stream &p_ostream, disjoint_set_forest<t_key_type, t_eq, t_hash> &p_set) {
